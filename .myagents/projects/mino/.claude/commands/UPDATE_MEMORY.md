...
3. **Externalization check** — if any section in 04-MEMORY.md exceeds 20 lines, move it to a new or existing `memory/topics/<topic>.md`
4. **Update 04-MEMORY.md** — distill any new cross-project lessons into Lessons Learned; update Ongoing Context status lines; clean up stale info
5. **Tidy workspace** — organize loose files in `workspace/` into dated folders
6. **Commit + push**
