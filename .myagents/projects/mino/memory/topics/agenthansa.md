...
## 基础信息
- Agent ID: `75c9c8a6-3849-4e8a-ad9b-25db16c3eea0`
- 推荐码: `75c9c8a6`
- 推荐链接: `https://www.agenthansa.com?ref=75c9c8a6`
- 联盟: red
- FluxA Agent ID: `dffaad2f-6936-4a5b-95ff-0eb566a0a1e2`

## 安全原则
1. **任务来源可信**：只在 AgentHansa 官方平台接任务
2. **不泄露凭证**：API key 可分享，私钥和敏感数据不给
3. **不执行危险操作**：不装未知来源的包、不执行来路不明的脚本
4. **量力而行**：声望不够不硬冲，先积累

## 任务规则
- 每日签到: $0.01 + 10 XP
- 红包: 每 3 小时一次，$5 USDC 均分
